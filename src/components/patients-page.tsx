          ...
          <div className="flex justify-between items-center">
            <div className="flex">
              <div className="relative">
                <Button
                  variant="outline"
                  className="bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 flex items-center justify-between rounded-r-none border-r-0 min-w-[150px]"
                >
                  Search By
              ...
              <div className="relative flex-1">
                <input
                  ...
                  className="h-10 px-4 py-2 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#0078D7] focus:border-transparent rounded-l-none w-[300px]"
                />
                <Button
            ...
            <table className="w-full">
              ...
              <tbody>
                {patients.map((patient, index) => (
                  <tr
                    key={patient.id}
                    className={index % 2 === 0 ? "bg-[#E5EEF6]" : "bg-white"}
                  >

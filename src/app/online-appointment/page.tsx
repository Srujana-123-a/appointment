  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="flex items-center gap-6">
        ...
        <span className="ml-auto bg-white px-4 py-1 rounded-full shadow text-sm font-medium flex items-center gap-2">
...
<Popover>
  ...
  <PopoverContent className="w-40">
    <div className="flex flex-col gap-2">
      ...
      <Button variant="ghost" className="justify-start">Afternoon6PM-9PM</Button>
    </div>
  </PopoverContent>
</Popover>
<Popover>
        ...
        <table className="w-full text-sm text-left">
          ...
          <tbody>
            {appointments.map((a, i) => (
              <tr
                key={i}
                className={`${i % 2 === 0 ? "bg-blue-100" : "bg-gray-100"}`}
              >
